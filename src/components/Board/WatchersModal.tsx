// src/components/Card/WatchersModal.tsx
...
const WatchersModal: React.FC<WatchersModalProps> = ({ isOpen, onClose, watchers }) => {
  return (
            ...
            >
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white dark:bg-gray-800 p-6 text-left align-middle shadow-xl transition-all">
                ...
                {watchers.length > 0 ? (
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">No watchers yet.</p>
                )}
              </Dialog.Panel>
            </Transition.Child>
          </div>
